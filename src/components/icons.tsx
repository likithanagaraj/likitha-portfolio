...
export const Icons = {
  ...
  responsiveDesignHand: (props: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
    ...
    >
      <g
        ...
        stroke-width="1.5"
      >
        <path d="m16.61 23.25l-3.789-3.094a1.637 1.637 0 0 1 1.755-2.743L15.75 18v-5.25a1.5 1.5 0 1 1 3 0v3l1.993.332a3 3 0 0 1 2.507 2.959v4.209m-19.5-6h-1.5a1.5 1.5 0 0 1-1.5-1.5V2.25a1.5 1.5 0 0 1 1.5-1.5h7.5a1.5 1.5 0 0 1 1.5 1.5v1.5M.75 14.25h3m-3-10.5h10.5" />
        <path d="M8.25 17.25a1.5 1.5 0 0 1-1.5-1.5v-7.5a1.5 1.5 0 0 1 1.5-1.5h13.5a1.5 1.5 0 0 1 1.5 1.5v4.5m-13.5-6v9m10.5-9v3" />
      </g>
    </svg>
  ),
