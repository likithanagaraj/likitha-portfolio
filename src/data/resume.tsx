...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      ...
      email: {
        name: "Send Email",
        url: "likithanagaraj2004@gmail.com",
        icon: Icons.email,
  ...
  projects: [
    ...
    {
      title: "Redef AI",
      href: "https://www.appykit-ui.com/gallery/redefai",
      // https://www.redefai.app
      // https://www.appykit-ui.com/gallery/redefai
      ...
      links: [
        ...
        // {
        //   type: "Source",
        //   href: "https://github.com/likithanagaraj/Redef_AI",
        //   icon: <Icons.github className="size-3" />,
        // },
      ],
      image: "",
    ...
    },
    {
      ...
      active: true,
      description:
        "UnicornSpaceUI is a UI library built to help developers ship faster.With reusable components, UI blocks, and templates for Next.js, it removes repetitive work and lets you focus on building real products.",
      technologies: [
        "Next.js",
        "Typescript",
        "PostgreSQL",
    ...
    },
    {
      ...
      active: true,
      description:
        "Paisa Logr is a simple app to track your income and expenses.Create dedicated spaces for events, trips, or personal use, and manage all your finances in an organized way without the clutter.",
      technologies: [
        "Dart",
        "Hive",
        "Flutter",
